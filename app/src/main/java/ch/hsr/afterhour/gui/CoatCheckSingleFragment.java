...
public class CoatCheckSingleFragment extends Fragment implements FragmentWithIcon {
    ...
    public CoatCheckSingleFragment() {
        // Required empty public constructor
    }

    public static CoatCheckSingleFragment newInstance(int param1, int param2) {
        CoatCheckSingleFragment fragment = new CoatCheckSingleFragment();
